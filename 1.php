	...
	$pilok = array();
		...
		do{
			array_push($mainArray, 
				array("Пилок" =>
					array(
						"Пилок трави" => 
							array(
								"Бермудська трава" => array($row['alergo104'], "Cyn d"),
						...
						"Пилок бур'янів" => 
							array(
								"Амарант (Щириця) " => array($row['alergo16'], "Ama r"),
			...
			array_push($mainArray, 
				array("Кліщ" => 
					array(
						"Європейський кліщ домашнього пилу" => array(
								"Американський кліщ домашнього пилу" => array($row['alergo108'], "Der f"),
						...
						"Борошняний кліщ" => array(
								"Acarus siro" => array($row['alergo2'], "Aca s"),
			...
			array_push($mainArray, 
				array("Пліснява та дріжжі" => 
					array(
						"Дріжджі" => array(
							"Candida Albicans " => array($row['alergo70'], "Can a"),
						...
						"Пліснява" => array(
							"Alternaria alternata " => array($row['alergo14'], "Alt a"),
			...
			array_push($mainArray, 
				array("Овочі" => 
					array(
						"Бобові культури" => array(
							"Арахіс" => array($row['alergo33'], "Ara h"),
						...
						"Спеції" => array(
							"Паприка " => array($row['alergo75'], "Cap a"),
						...
						"Овочі та гриби" => array(
							"Білий гриб" => array($row['alergo8'], "Aga b"),
						...
						"Горіхи" => array(
							"Кешью " => array($row['alergo21'], "Ana o"),
						...
						"Насіння" => array(
							"Насіння гарбуза " => array($row['alergo101'], "Cuc p"),
			...
			array_push($mainArray, 
				array("Продукти тваринного походження" => 
					array(	
						"Молоко" => array(
							"Коров'яче молоко " => array($row['alergo61'], "Bos d 4"),
						...
						"Яйце" => array(
							"Яєчний білок " => array($row['alergo138'], "Gal d 1"),
						...
						"Морепродукти" => array(
							"Anisakis simplex " => array($row['alergo23'], "Ani s 1"),
						...
						"М'ясо" => array(
							"Яловичина" => array($row['alergo63'], "Bos d 6"),
			...
			array_push($mainArray, 
				array("Тваринного пожодження" => 
					array(	
						"Домашні тварини" => array(),
						"Домашня худоба" => array()
					)
				)
			);
			array_push($mainArray, 
				array("Інший" => 
					array(	
						"Латекс" => array(
							"Латекс " => array($row['alergo157'], "Hev b"),
						...
						"Фікус та Хміль" => array(
							"Фікус" => array($row['alergo131'], "Fic b"),
							"Хміль" => array($row['alergo167'], "Hum l")
						),
						"CCD" => array(
							"Ананас" => array($row['alergo20'], "Ana c 2"),
